...
@Component({
  ...
  templateUrl: '../../../tl-common/components/tl-toggler/tl-toggler.component.html',
  styleUrls: ['../../../tl-common/components/tl-toggler/tl-toggler.component.scss']
})
export class TlFbaseTogglerComponent extends TlTogglerComponent implements OnInit, OnChanges {
