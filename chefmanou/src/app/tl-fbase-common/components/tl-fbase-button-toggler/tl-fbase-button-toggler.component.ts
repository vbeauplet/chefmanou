...
@Component({
  ...
  templateUrl: '../../../tl-common/components/tl-button-toggler/tl-button-toggler.component.html',
  styleUrls: ['../../../tl-common/components/tl-button-toggler/tl-button-toggler.component.scss']
})
